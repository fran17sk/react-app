            ...
            <nav className="navbar navbar-expand-lg navbar-dark fondonav menu menu-fixed menudos">
                <div className="container-fluid">
                    ...
                    <form className="d-flex">
                        ...
                        <button className="btn" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-search colorLupa" viewBox="0 0 16 16">
                    ...
                    <form className="d-flex iconos">
                        <a href="./main/micuenta.html"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-person-circle color" viewBox="0 0 16 16">
                ...
                <div className="fondoOpciones">
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0 d-flex opciones">
                            ...
                            <li className="nav-item">
                                <a className="nav-link active" onclick="msj()" aria-current="page" href="#">PRODUCTO</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link active" aria-current="page" href="./main/contact.html">CONTACTO</a>
                            </li>
                        </ul>
                    </div>
                </div>
